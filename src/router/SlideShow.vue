...
<template>
  <div class="reveal">
    <div class="slides">
      <section>
        <h3 class="display-3 py-3" style="line-height:70px">
          <span class="display-4 primary--text">OpenGeode </span><br />
          an industrial open source geosciences meshing framework
        </h3>
        <span class="display-1"><b>Arnaud Botella</b> and Pierre Anquez</span
        ><br />
        <img
          src="@/assets/logo.png"
          height="150"
      ...
      <section>
        ...
        <v-layout
          style="position:relative; width:800px; height:200px; margin:0 auto;"
          class="justify-center"
        >
          <img
            style="position:absolute;top:0;left:0;"
            src="@/assets/geomodeling1.svg"
          />
          <img
            class="fragment"
            style="position:absolute;top:0;left:0;"
            src="@/assets/geomodeling2.svg"
          />
        </v-layout>
        <p class="caption">Model from Caumon et al., Math Geosci, 2009</p>
        <p class="caption">Mesh and simulation from Botella, 2016</p>
        <p class="message fragment">
      ...
      <section>
        ...
        <div class="fragment">
          ...
          <p class="caption">
            Image from Pellerin, 2014. Model courtesy of RING Consortium
          </p>
        </div>
      </section>
      ...
      <section>
        ...
        <p class="message fragment py-5">
          No data model <b>combines</b> these three points.
        </p>
      </section>
      <section>
        <p class="slidetitle">Our proposal</p>
        <v-layout
          style="position:relative; width:800px; height:800px; margin:0 auto;"
          class="justify-center"
        >
          <img
      ...
      <section>
        <p class="sectiontitle">III - Short demo</p>
        <p>Objectives</p>
        <ul>
      ...
      <section>
        OpenGeode is designed to be a C++ framework
        <ul>
      ...
      <section>
        <p class="slidetitle">Perspectives</p>
        <section>
          <p>Export/Import</p>
      ...
      <section>
        ...
        <p>
          We think we are fully equipped to design fully reliable tools. <br />
          Ex: given a valid geological model, surface remeshing & tetrahedral
          meshing <b class="fragment">100% reliable.</b>
        </p>
